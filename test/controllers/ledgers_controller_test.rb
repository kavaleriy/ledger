...
class LedgersControllerTest < ActionController::TestCase
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post :create, ledger: { credit_acc: @ledger.credit_acc, current_acc: @ledger.current_acc, customer: @ledger.customer, sc_addr: @ledger.sc_addr }
    end
  ...
  test "should update ledger" do
    patch :update, id: @ledger, ledger: { credit_acc: @ledger.credit_acc, current_acc: @ledger.current_acc, customer: @ledger.customer, sc_addr: @ledger.sc_addr }
    assert_redirected_to ledger_path(assigns(:ledger))
  end
